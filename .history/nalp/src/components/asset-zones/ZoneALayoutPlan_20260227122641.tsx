          ...
          {(() => {
            ...
            return (
              <g>
                ...
                {/* مسار الخروج — مخرج ١ يبدأ من منتصف تجميع يسار المنصة */}
                <path
                  d={`M ${collectZoneX + (platformX - collectZoneX - 4) / 2} ${platformY + platformH / 2} L ${roadCenterX + gw / 2 - 5} ${h - gateDepth - 30} L ${stripW + gw / 2} ${h - gateDepth - 15}`}
                  fill="none"
                  stroke="#f59e0b"
                  strokeWidth={2}
                  strokeDasharray="6 4"
