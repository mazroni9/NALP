          ...
          {dims.id === "a" && (
            <g className="zone-a-gates">
              {(() => {
                ...
                return (
                  <>
                    {/* مدخل شرقي — من طريق الجبيل (شمال شرق) */}
                    <rect x={w - roadLen} y={h * 0.18 - gw / 2} width={roadLen} height={gw} fill="#dcfce7" fillOpacity={0.7} stroke="#22c55e" strokeWidth={2} />
                    <text x={w - 8} y={h * 0.18} textAnchor="middle" dominantBaseline="middle" className="fill-green-800 text-xs font-bold">مدخل 7م</text>
