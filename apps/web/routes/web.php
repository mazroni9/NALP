...
Route::get('/asset/zones', fn () => Inertia::render('Public/ZonesOverview'))->name('zones');
Route::get('/asset/zone-a', fn () => Inertia::render('Public/ZoneA'))->name('zone-a');
Route::get('/asset/zone-b', fn () => Inertia::render('Public/ZoneB'))->name('zone-b');
...
Route::post('/contact/nda', [ContactController::class, 'nda'])->name('contact.nda');
Route::post('/contact/data-room', [ContactController::class, 'dataRoom'])->name('contact.data-room');
