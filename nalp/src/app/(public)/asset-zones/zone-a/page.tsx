        ...
        <Card>
          ...
          <div className="mt-4 space-y-4 text-slate-600">
            ...
            <section>
              ...
              <p>المزاد يُقام يومياً؛ تدخل السيارات وتُعرض وتُباع وتغادر في نفس اليوم. السيارات التي لم تُبع أو تحتاج تأخيراً تغادر خلال 24 ساعة حسب سياسة التشغيل. التأخير عن 24 ساعة يترتب عليه رسوم 20 ريال عن كل يوم أو جزء منه.</p>
            </section>
            <section>
              <h3 className="font-medium text-slate-800">تكاليف الاحتفاظ في الساحة</h3>
              <p>السيارات التي تتجاوز 24 ساعة دون بيع أو تحريك تُحمَّل رسوماً قدرها 20 ريال عن كل يوم تأخير أو جزء منه، لتشجيع الإخلاء السريع وتحفيز الكفاءة التشغيلية.</p>
            </section>
          </div>
        </Card>
        <Card>
