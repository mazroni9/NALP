      ...
      <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <section className="space-y-12">
          ...
          <div className="mt-10 mb-6">
            ...
            <h4 className="mt-6 mb-2 font-semibold text-slate-800">
            ...
            <ol className="list-decimal list-inside space-y-1 text-slate-700">
              <li><strong>الأولوية الأولى:</strong> تسديد الدين حتى الوصول لنقطة التعادل.</li>
              <li><strong>ثانياً:</strong> توزيع رواتب مجلس الإدارة.</li>
              <li><strong>ثالثاً:</strong> توزيع أرباح بقية المساهمين (الملاك والمشغّل والمستثمر حسب النسب).</li>
            </ol>
            <p className="mt-3">
              ما يتبقى من قيمة الحد المسموح به (10٪ كحد أقصى للمصاريف الإدارية) يُوزَّع بعدالة إما لمَن يُحقق أداءً متميزاً من مجلس الإدارة، أو لتكاليف قضائية لحماية حقوق الملاك.
            </p>
          </div>
