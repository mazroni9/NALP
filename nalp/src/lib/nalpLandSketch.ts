...
export const ZONE_CONFIGS: ZoneConfig[] = [
  ...
  },
  {
    ...
    description:
      "منطقة سكن الموظفين والمرافق تقع في الجزء الهادئ من الأرض، وتوفر بيئة معيشية مريحة للعاملين. تضم مباني سكنية حديثة بطابقين تحقق حوالي 225 غرفة بنمط استوديو، إضافة إلى مبنى خدمات مركزية يضم مقهى/مطعم صغير، ميني ماركت، ومغسلة، مع ساحات خضراء طولية وممرات مشاة.",
  },
  {
    id: "d",
