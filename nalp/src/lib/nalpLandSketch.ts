...
export const ZONE_CONFIGS: ZoneConfig[] = [
  ...
  },
  {
    ...
    shortDesc: "تطل على الشارع الداخلي، ورش صيانة وتنجيد ومغسلة سيارات نموذجية.",
    description:
      "المنطقة الاستثمارية (78م × 52.5م) تطل مباشرة على الشارع الداخلي بعرض 30م من الغرب، وتجاور منطقة سكن الموظفين من الشرق. تُقسّم إلى ثلاثة أقسام: القسم 1 (52.5×39 م) ورشة صيانة سيارات نموذجية، القسم 2 (26.25×39 م) ورشة تنجيد وتجديد للسيارات وتلميعها، والقسم 3 (26.25×39 م) مغسلة سيارات نموذجية. صُممت لتستفيد من واجهة الشارع وتعوّض جزءاً من المساحة المخصّصة للممر الداخلي.",
  },
];
